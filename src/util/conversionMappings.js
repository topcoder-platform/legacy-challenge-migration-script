...
module.exports = {
  ...
  V4_TO_V5: {
    ...
    [V4_TRACKS.DEVELOP]: {
      ...
      [V4_SUBTRACKS.DEVELOP_MARATHON_MATCH]: (_isTask, tags) => buildV5Data(V5_TRACK_IDS.DATA_SCIENCE, V5_TYPE_IDS.CHALLENGE, [_.includes(tags, DATA_SCIENCE_MATCH_TAG) ? DATA_SCIENCE_MATCH_TAG : MARATHON_MATCH_TAG]),
